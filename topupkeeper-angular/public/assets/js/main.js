...
$(document).ready(function() {
	// Show operator radio buttons when a country is selected
	$('#country_select').change(function() {
		if ($(this).val() !== "") {
			$('#operator_section').show();
		} else {
			$('#operator_section').hide();
			$('#phone_section, #amount_section, #validate_section').hide(); // Hide all subsequent sections
		}
	});

	// Show phone number input when an operator is selected
	$('.operator_radio').change(function() {
		$('#phone_section').show();
	});

	// Show amount radio buttons when a phone number is entered
	$('#phone_number').on('input', function() {
		if ($(this).val() !== "") {
			$('#amount_section').show();
		} else {
			$('#amount_section, #validate_section').hide(); // Hide the next section if the phone number is cleared
		}
	});

	// Show validate button when an amount is selected
	$('.amount_radio').change(function() {
